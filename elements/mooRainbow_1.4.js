...
var MooRainbow = new Class({
	...
	OverlayEvents: function() {
		...
		inputs.each(function(el) {
			el.addEvent('keydown', function(e){ this.eventKeydown(e, el)}.bind(this));
			el.addEvent('keyup', function(e){ this.eventKeyup(e, el)}.bind(this));
		}, this);
	...
	wheelEvents: function() {
		var arrColors = Array.clone(this.arrRGB);
		arrColors.append(this.arrHSB);

		arrColors.each(function(el) {
			el.addEvents({
				'mousewheel': function(e){ this.eventKeys(e, el)}.bind(this),
				'keydown': function(e){ this.eventKeys(e, el)}.bind(this)
			});
		}, this);
		
		[this.layout.arrows, this.layout.slider].each(function(el) {
			el.addEvents({
				'mousewheel': function(e){ this.eventKeys(e, this.arrHSB[0])}.bind(this),
				'keydown': function(e){ this.eventKeys(e, this.arrHSB[0])}.bind(this)
			});
		}, this);
	},
	...
	doLayout: function() {
		...
		new Element('span', {'styles': {'position': 'absolute'}, 'class': prefix + 'ballino'}).set('html', " &deg;").inject(HU);
	...
	rePosition: function() {
		...
		this.layout.setStyles({
			'left': coords.left + this.options.deslocamentoX,
			'top': coords.top + coords.height + 1 + this.options.deslocamentoY
		});
	},
